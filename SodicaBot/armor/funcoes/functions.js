...
console.log(`Error identificado: ${erro}`)
}
}
...
const banner2 = cfonts.render(('Pwered By Sodica'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`SODICA BOT`), {
font: 'tiny',             
align: 'center',           
...
authorname = 'SodicaSquad'
packname = 'SS'
  
function addMetadata(packname, author) {	
if (!packname) packname = 'RT'; if (!author) author = 'SodicaSquad';	
